...
class SearchModal(dmc.Modal):
    ...
    def __init__(self):
        ...
        def create_search_filter(title, description, icon, prefix):
            attributes = {
                'data-search-key': prefix, 
                'data-search-item-type': 'btn'
            }
        ...
        modal_content = dmc.Stack(
            ...
            children=[
                dmc.TextInput(
                    ...
                    variant='unstyled',
                    w='100%',
                    leftSection=DashIconify(icon='material-symbols:search-rounded', height=25).to_plotly_json(),
                    size='md',
            ...
            children=dmc.Group([
                ...
                html.Div(
                    ...
                    children=dmc.TextInput(
                        ...
                        radius='xl',
                        h=35,
                        leftSection=DashIconify(icon='material-symbols:input-circle-rounded', height=20, rotate=1).to_plotly_json(),
                        variant='filled',
                        readOnly=True,
                        rightSection=DashIconify(icon='material-symbols:search-rounded', height=20).to_plotly_json(),
                    )
                )
            ], 
